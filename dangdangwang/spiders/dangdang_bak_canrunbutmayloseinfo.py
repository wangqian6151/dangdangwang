...
class DangdangSpider(scrapy.Spider):
    ...
    def parse_forth(self, response):
        ...
        print('parse_forth response.url {}:'.format(response.url))
        self.logger.debug('parse_forth response.url {}:'.format(response.url))
        forth_category = ''
        url = response.url
    ...
    def parse_fifth(self, response):
        ...
        if '价格' in response.xpath('//*[@id="navigation"]/ul/li/@dd_name').extract():
            le = LinkExtractor(restrict_xpaths='//*[@id="navigation"]/ul/li[@dd_name="价格"]/div[2]/div[1]/div')
            for link in le.extract_links(response):
                print('parse_fifth scrapy the subcategory url:{},text{}'.format(link.url, link.text))
                self.logger.debug('parse_fifth scrapy the subcategory url:{},text{}'.format(link.url, link.text))
                yield Request(link.url, callback=self.parse_books,
                              meta={'first_category': first_category, 'second_category': second_category,
                                    'third_category': third_category, 'forth_category': forth_category})
        else:
    ...
    # def parse_sixth(self, response):
    #     print('6' * 20)
    #     first_category = response.meta.get('first_category')
    #     second_category = response.meta.get('second_category')
    #     third_category = response.meta.get('third_category')
    #     forth_category = response.meta.get('forth_category')
    #     print('parse_sixth response.url:' + response.url)
    #     self.logger.debug('parse_sixth response.url:' + response.url)
    #
    ...
    #         for link in le.extract_links(response):
    #             print('parse_sixth 等于100后 url:{},text{}'.format(link.url, link.text))
    #             self.logger.debug('parse_sixth 等于100后 url:{},text{}'.format(link.url, link.text))
    #             yield Request(link.url, callback=self.parse_books,
    #                           meta={'first_category': first_category, 'second_category': second_category,
    #                                 'third_category': third_category, 'forth_category': forth_category})
    #
    #         # if '折扣' in response.xpath('//*[@id="navigation"]/ul/li/@dd_name').extract():
    #         #     le = LinkExtractor(restrict_xpaths='//*[@id="navigation"]/ul/li[@dd_name="价格"]/div[2]/div[1]/div')
    #         #     for link in le.extract_links(response):
    #         #         print('parse_sixth 等于100后折扣 url:{},text{}'.format(link.url, link.text))
    #         #         self.logger.debug('parse_sixth 等于100后折扣 url:{},text{}'.format(link.url, link.text))
    #         #         yield Request(link.url, callback=self.parse_books,
    #         #                       meta={'first_category': first_category, 'second_category': second_category,
    #         #                             'third_category': third_category, 'forth_category': forth_category})
    #         # elif '客户评分' in response.xpath('//*[@id="navigation"]/ul/li/@dd_name').extract():
    #         #     le = LinkExtractor(restrict_xpaths='//*[@id="navigation"]/ul/li[@dd_name="客户评分"]/div[2]/div[1]/div')
    #         #     for link in le.extract_links(response):
    #         #         print('parse_sixth 等于100后客户评分 url:{},text{}'.format(link.url, link.text))
    #         #         self.logger.debug('parse_sixth 等于100后客户评分 url:{},text{}'.format(link.url, link.text))
    #         #         yield Request(link.url, callback=self.parse_books,
    #         #                       meta={'first_category': first_category, 'second_category': second_category,
    #         #                             'third_category': third_category, 'forth_category': forth_category})
    #
